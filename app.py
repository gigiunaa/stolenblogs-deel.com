...
# ------------------------------
# Screenshot function (HCTI)
# ------------------------------
def make_screenshot(html_code: str) -> str:
    try:
        url = "https://hcti.io/v1/image"
        auth = (
            os.environ.get("HCTI_USER_ID"),
            os.environ.get("HCTI_API_KEY")
        )
        data = {"html": html_code}
...
def scrape_blog():
    try:
        ...
        # Make screenshot
        screenshot_url = make_screenshot(content_html)
